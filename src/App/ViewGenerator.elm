module ViewGenerator exposing (boolStudyLvl, buildDivs, buildFullJobElement, buildJobPreviewElement, concatString, determineStudyLvl, formatJobLanguages, formatLanguageTuple, hrefo)
